...
RUN if grep -q Debian /etc/os-release && grep -q jessie /etc/os-release; then \
    ...
    && apt-get update; apt-get install --no-install-recommends -y -t jessie-backports openjdk-8-jre openjdk-8-jre-headless openjdk-8-jdk openjdk-8-jdk-headless; rm -rf /var/lib/apt/lists/*; \
    ...
    && apt-get update; apt-get install --no-install-recommends -y openjdk-8-jre openjdk-8-jre-headless openjdk-8-jdk openjdk-8-jdk-headless; rm -rf /var/lib/apt/lists/*; \
  else \
    apt-get update; apt-get install --no-install-recommends -y openjdk-8-jre openjdk-8-jre-headless openjdk-8-jdk openjdk-8-jdk-headless; rm -rf /var/lib/apt/lists/*; \
  fi
...
RUN FIREFOX_URL="https://s3.amazonaws.com/circle-downloads/firefox-mozilla-build_47.0.1-0ubuntu1_amd64.deb" \
  ...
  && dpkg -i /tmp/firefox.deb || apt-get -f -y install \
...
RUN apt-get install --no-install-recommends -y libgconf-2-4 && rm -rf /var/lib/apt/lists/*;
