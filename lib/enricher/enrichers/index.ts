...
adduser,apk,apt_add_repository,apt_get,apt_key,apt,bash,bundle,cat,cd,chmod,chown,cmake,conda,configure,cp,curl,dnf,docker_php_ext_install,dotnet,dpkg_architecture,dpkg,echo,exit,_export,find,firefox,gem,git,go,google_chrome,gpg,grep,groupadd,jq,ldconfig,ln,locale_gen,ls,make,mkdir,mktemp,mv,npm,nproc,pecl,php,pip,printf,python,rm,rpm,sed,set,sh,sha256sum,sha512sum,sort,sudo,tar,tee,touch,_true,unzip,useradd,wget,which,xargs,yarn,yum,]
