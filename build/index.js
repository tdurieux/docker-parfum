...
exports.parseAndMatch = exports.Matcher = exports.Violation = exports.HADOLING_RULES = exports.hadoling_rules = exports.rules = exports.BINNACLE_RULES = exports.RULES = void 0;
...
function parseAndMatch(dockerfile) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, (0, dinghy_1.parseDocker)(new dinghy_1.File(null, dockerfile))];
                case 1:
                    ast = _a.sent();
                    return [2, new rule_matcher_1.Matcher(ast).matchAll()];
            }
        });
    });
}
